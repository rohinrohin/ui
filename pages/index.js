...
export default function Home() {
  ...
  return (
    <>
      ...
      <div
        className="relative w-screen h-screen flex content-center items-center justify-center overflow-hidden"
                ...
                <div className="flex h-2/6 flex-col">
                  ...
                  {type == "dialog" && (
                    <div className="text-white text-2xl text-center">
                      Roleplay the conversation on the next page with your
                      child. <br />
                      Try to mimic the expression specified in front of the
                      dialogue. <br />
                      <br />
                      <b>Parent</b> reads the story when its{" "}
                      <span className="text-blue-400">blue</span> and{" "}
                      <span className="text-green-400">green</span> for the{" "}
                      <b>child</b>.
                    </div>
                  )}
                  ...
                  {type == "story" && (
                    <div className="text-white text-2xl text-center">
                      Please narrate the story in the next page to your child
                      and answer any questions that may follow.
                    </div>
                  )}
